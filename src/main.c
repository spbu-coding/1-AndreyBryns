...
double calculate_by_medium_rectangle_method(double a, double b, double step_size)
{
...
double calculate_by_simpson_method(double a, double b, double step_size)
{
...
char **method_comparison(double a, double b, const unsigned int *step_sizes, unsigned int step_sizes_length)
{
	...
	{
		double medium_rectangle_method_result = calculate_by_medium_rectangle_method(a, b, step_sizes[i]), simpson_method_result = calculate_by_simpson_method(a, b, step_sizes[i]);
